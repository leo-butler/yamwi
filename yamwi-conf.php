...
// Site-specific customization should be made in site-conf.php.

$default_mode = 2; // 0 -> Syntactic output,
           // 1 -> ASCII-Art output,
...
$movie_is_embedded = 0; // for webm or mp4, it can be 0 or 1.

$movie_term = 'svg'; // Gnuplot terminal used to generate frames
